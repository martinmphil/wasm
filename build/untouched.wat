(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 4104))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 20488))
 (global $~lib/memory/__heap_base i32 (i32.const 20488))
 (memory $0 1)
 ...
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "versus" (func $assembly/index/versus))
 ...
 (func $assembly/index/versus (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result f64)
  (local $4 f64)
  (local $5 f64)
  (local $6 f64)
  f64.const 1
